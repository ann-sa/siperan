...
<body>
			...
			<div class="col-md-4 wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				...
				<form class="login100-form validate-form" method="POST" action="<?php echo base_url(); ?>index.php/utama/loginmahasiswa">
					...
					<br>
					<center>
						<a href="<?php echo base_url(); ?>index.php/utama/tentang/indexmahasiswa">Tentang</a>
						<br>
