      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box">
            ...
            ?>
                <form action="<?php echo base_url(); ?>index.php/mahasiswa/editorsak/page2?id_surat=<?php echo $sak->id_surat_aktif ;?>" method="POST">
                <table class="table table-bordered">
				
				<tr>
                  <td width="30%">Nama</td>
                  <td><input type="text" class="form-control" name="nama" value="<?php echo $sak->Nama ;?>"readonly></td>
                </tr>
			
				<tr>
                  <td>NIM</td>
                  <td><input type="text" class="form-control" name="nim" value="<?php echo $sak->NIM ;?>"readonly></td>
                </tr>
			
                <tr>
                  <td>No HP</td>
                  <td><input type="text" class="form-control" name="hp" value="<?php echo $sak->hp ;?>"readonly></td>
                </tr>
				
				<tr>
                  <td>Email</td>
                  <td><input type="text" class="form-control" name="email" value="<?php echo $sak->Email ;?>"readonly></td>
                </tr>
				
				<tr>
                  <td>Tempat, Tanggal lahir</td>
                  <td><input type="text" class="form-control" name="ttl" value="<?php echo $sak->TempatLahir ;?>, <?php echo $tgl_d.' '.$bulan_lahir.' '.$tgl_Y;?>"readonly></td>
                </tr>
				
				<tr>
                  <td>Jenjang Studi</td>
                  <td><input type="text" class="form-control" name="prodi" value="<?php echo $sak->JenjangStudi ;?>"readonly></td>
                </tr>
				
				<tr>
                  <td>Program Studi</td>
                  <td><input type="text" class="form-control" name="prodi" value="<?php echo $sak->Prodi ;?>"readonly></td>
                </tr>
			  ...
			  <td width="40%" align="center">Halaman 1 dari 4</td>
